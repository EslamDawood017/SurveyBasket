...
namespace SurveyBasket.Api.Migrations
{
    ...
    [Migration("20250415072521_adding IsActive Col To User Table ")]
    partial class addingIsActiveColToUserTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
                    ...
                    b.OwnsMany("SurveyBasket.Api.Entities.RefreshToken", "RefreshTokens", b1 =>
                        {
                            ...
                            b1.Property<DateTime>("CreadtedOn")
                                .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("SurveyBasket.Api.Entities.Vote", b =>
                {
                    b.HasOne("SurveyBasket.Api.Entities.ApplicationUser", "ApplicationUser")
                        .WithMany()
